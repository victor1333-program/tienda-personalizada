...
CREATE TABLE "Config" (
    "id" TEXT NOT NULL,
    "invoiceStart" INTEGER NOT NULL DEFAULT 1000,
    "taxRate" DOUBLE PRECISION NOT NULL DEFAULT 21.0,
    "orderEmail" TEXT NOT NULL DEFAULT 'pedidos@tuempresa.com',
    "contactEmail" TEXT NOT NULL DEFAULT 'contacto@tuempresa.com',
    "invoiceEmail" TEXT NOT NULL DEFAULT 'facturas@tuempresa.com',
